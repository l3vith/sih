...
const STR: Dict = {
  ...
  headLibrary: { en: 'Organize reports like Drive — folders, filters, and quick actions.', hi: 'ड्राइव जैसी तरह रिपोर्ट व्यवस्थित करें — फ़ोल्डर, फ़िल्टर और त्वरित क्रियाएँ।' },
  ...
  // Library / Drive (Google Drive-style)
  foldersTitle: { en: 'LIBRARY', hi: 'लाइब्रेरी' },
  driveTitle: { en: 'Drive', hi: 'ड्राइव' },
  myDrive: { en: 'My Drive', hi: 'मेरी ड्राइव' },
  driveEmptyTitle: { en: 'Your Drive is empty', hi: 'आपकी ड्राइव खाली है' },
  driveEmptyBody: { en: 'Upload a DDR, WCR or image — then organize into folders.', hi: 'DDR, WCR या छवि अपलोड करें — फिर फ़ोल्डरों में व्यवस्थित करें।' },
  createFolderTitle: { en: 'New folder', hi: 'नया फ़ोल्डर' },
  viewGrid: { en: 'Grid', hi: 'ग्रिड' },
  viewList: { en: 'List', hi: 'सूची' },
  detailsPane: { en: 'Details', hi: 'विवरण' },
  openDoc: { en: 'Open', hi: 'खोलें' },
  groupBy: { en: 'GROUP BY', hi: 'समूहीकृत करें' },
  sortBy: { en: 'SORT', hi: 'क्रम' },
  filterDocs: { en: 'Filter docs…', hi: 'दस्तावेज़ फ़िल्टर…' },
  newFolder: { en: '+ New folder', hi: '+ नया फ़ोल्डर' },
  folderNamePh: { en: 'Folder name', hi: 'फ़ोल्डर नाम' },
  createBtn: { en: 'Create', hi: 'बनाएँ' },
  cancelBtn: { en: 'Cancel', hi: 'रद्द करें' },
  unfiled: { en: 'Unfiled', hi: 'बिना फ़ोल्डर' },
  noDocsInFolder: { en: 'No docs here — drag or move one in.', hi: 'यहाँ कोई दस्तावेज़ नहीं — खींचें या ले जाएँ।' },
  docCount: { en: '{{count}} docs', hi: '{{count}} दस्तावेज़' },
  moveTo: { en: 'Move to…', hi: 'ले जाएँ…' },
  moveToFolder: { en: 'Move to folder', hi: 'फ़ोल्डर में ले जाएँ' },
  renameFolder: { en: 'Rename', hi: 'नाम बदलें' },
  deleteFolder: { en: 'Delete folder', hi: 'फ़ोल्डर हटाएँ' },
  deleteDoc: { en: 'Delete', hi: 'हटाएँ' },
  deleteDocConfirm: { en: 'Delete {{name}}? Removes DB row + Storage file.', hi: '{{name}} हटाएँ? DB पंक्ति + स्टोरेज फ़ाइल हटेगी।' },
  deleteFolderConfirm: { en: 'Delete folder “{{name}}”? Docs move to Unfiled.', hi: 'फ़ोल्डर “{{name}}” हटाएँ? दस्तावेज़ Unfiled में जाएँगे।' },
  gFolder: { en: 'Folders', hi: 'फ़ोल्डर' },
  gFormation: { en: 'Formation', hi: 'फ़ॉर्मेशन' },
  gWell: { en: 'Well', hi: 'कुआँ' },
  gType: { en: 'Type', hi: 'प्रकार' },
  sName: { en: 'Name', hi: 'नाम' },
  sRecent: { en: 'Recent', hi: 'हालिया' },
  sFormation: { en: 'Formation', hi: 'फ़ॉर्मेशन' },
  sDepth: { en: 'Depth', hi: 'गहराई' },
  typePdf: { en: 'PDF', hi: 'PDF' },
  typeImage: { en: 'Image', hi: 'छवि' },
  docsWord: { en: 'docs', hi: 'दस्तावेज़' },
  breadcrumbAll: { en: 'All files', hi: 'सभी फ़ाइलें' },
